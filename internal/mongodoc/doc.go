...
// on one specific revision of the charm or bundle - see
// also BaseEntity.
//
// We ensure that there is always a single BaseEntity for any
// set of entities which share the same revisionless URL.
type Entity struct {
...
type BaseEntity struct {
	...
	// regardless of its revision or promulgation status.
	// (this omits the revision from URL)
	// e.g., cs:~user/collection/series/foo
	URL *charm.Reference
